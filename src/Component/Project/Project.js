...
const Project = () => {
  const projects = [
    { id: '1', url: 'https://talenttower-lbu8.onrender.com', title: 'Talent Tower', description: 'Discover careers', img: talent },
  ...
  return (
    ...
    {/* <div class="animicontainer">
      ...
      <img src={Arena} alt='arena'/>
      <img src={excefort} alt='excefort'/>
      <img src={eatrs} alt='talent'/>
      <img src={talent} alt='talent'/>
      <img src={Cardily} alt='talent'/>
